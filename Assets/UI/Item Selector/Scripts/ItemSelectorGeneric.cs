...
{
    public class ItemSelectorGeneric<T> : UIElement
    {
        ...
        [Header("Options:")]
        [SerializeField] private List<SelectorOption<T>> _options;

        public UnityEvent<SelectorOption<T>> onOptionChanged;

        private int _position;

        public SelectorOption<T> ActiveOption { get => _options[_position]; }
        ...
        private void Scroll(Direction direction)
        {
            ...
            onOptionChanged.Invoke(ActiveOption);
        }
